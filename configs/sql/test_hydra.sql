...
--
-- Host: 192.168.1.200    Database: test_hydra
-- ------------------------------------------------------
...
CREATE TABLE `capabilities` (
  ...
  PRIMARY KEY (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Table to store render node capabilities, eg Maya, VRay, Redshift, Windows, Linux, etc. ';
...
INSERT INTO `capabilities` VALUES ('TestCapability');
...
CREATE TABLE `jobs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Table for storing jobs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jobs` VALUES (1,'TestJob','TestUser','R','2021-01-02 14:20:04','TestCapability','','',50,1,0,'',0,10,0,1,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Table to store render node records ';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `render_nodes`
--

LOCK TABLES `render_nodes` WRITE;
/*!40000 ALTER TABLE `render_nodes` DISABLE KEYS */;
INSERT INTO `render_nodes` VALUES (1,'test_host','O',0,'win32','192.168.1.50',NULL,'TestCapability',NULL,NULL,0);
/*!40000 ALTER TABLE `render_nodes` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Table to store tasks';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tasks` VALUES (1,1,'R',50,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2021-03-08 23:08:38
